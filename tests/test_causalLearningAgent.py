...
from easl.controller import CausalLearningController
...
class TestCausalLearningAgent(TestCase):
    def test_conditional_probability(self):
        ...
        self.assertEqual(0.5, CausalLearningController.conditional_probability(["Coin1", "Coin2"], ab, "heads", "tails"))
    ...
    def test_are_independent_independent(self):
        ...
        self.assertTrue(CausalLearningController.are_independent("Coin1", "Coin2", d))
    ...
    def test_are_independent_dependent(self):
        ...
        self.assertFalse(CausalLearningController.are_independent("Weather", "Temperature", d))
    ...
    def test_are_conditionally_independent3(self):
        ...
        self.assertTrue(CausalLearningController.are_conditionally_independent("Coin1", "Coin2", ["Coin3"], d))
    ...
    def test_are_conditionally_independent4(self):
        ...
        self.assertTrue(CausalLearningController.are_conditionally_independent("Coin1", "Coin2", ["Coin3", "Coin4"], d))
    ...
    def test_are_conditionally_independent_not_independent(self):
        ...
        self.assertFalse(CausalLearningController.are_conditionally_independent("Coin1", "Coin2", ["Coin3"], d))
